...
resource "aws_instance" "kservice"{
    ...
    user_data =  <<-EOF
              ...
              GIT_SSH_COMMAND="ssh -o StrictHostKeyChecking=no" git clone https://github.com/mleonpaa/AutoKube.git /home/ubuntu/AutoKube
              sudo chown -R ubuntu:ubuntu /home/ubuntu/AutoKube/
              EOF
